...
const targetContainer = /{reactionMenuId && \([\s\S]*?\}\)[\s]*\{\/\* Chat Feed \*\/\}[\s]*<div className="flex-1 overflow-y-auto px-2 md:px-4 py-2 space-y-1.5 scrollbar-thin">/;

const newContainer = `{reactionMenuId && (
                  <div
