    ...
    >
      ...
      <div className="flex flex-1 h-0 relative">
        ...
        <main
          ...
          style={{
            background: chatBg
              ? `url(${chatBg}) center/cover no-repeat`
              : undefined,
          }}
        >
                          ...
                          {isLiz ? (
                            <div className="flex gap-2 w-full max-w-[98%] mt-1">
                              <div
                                ...
                                onClick={() =>
                                  senderInfo && setSelectedUserModal(senderInfo)
                                }
                              >
                                <img
                                  referrerPolicy="no-referrer"
                                ...
                                {decUrl && (
                                  <div className="absolute -inset-3 pointer-events-none z-10 flex items-center justify-center">
                                    <img
                                      referrerPolicy="no-referrer"
                                      src={decUrl}
                                      className="w-[130%] h-[130%] object-contain filter drop-shadow-sm"
                              ...
                              <div className="flex flex-col border-l-[3px] border-[#D4AF37]/20 pl-2.5 ml-1 flex-1 min-w-[200px]">
                                <div className="flex flex-col w-full relative">
                                  ...
                                  >
                                    ELIZABETH{" "}
                                    {m.isAi && "(IA Administradora Gemini ✨)"}
                                  </span>
                                  ...
                                  <div className="flex flex-wrap items-end justify-between gap-2">
                                    <span
                                      className="text-[#E8D9B0] text-[14px] leading-snug flex-1 cursor-pointer hover:bg-white/5 rounded px-1 transition-colors"
                                    ...
                                    <button
                                      onClick={() => setReplyingTo(m)}
                                      className="opacity-0 group-hover:opacity-100 transition-opacity text-[#D4AF37] hover:text-white p-1"
                                      title="Responder"
                                    >
                                      <svg
                                    ...
                                    <span className="text-[#8B98B0] text-[11px] font-mono shrink-0 ml-auto pl-2">
                                      {timeStr}
                                    </span>
                                  </div>
                                </div>
                                {m.image && (
                                  <div className="mt-1.5">
                                    <img
                                      referrerPolicy="no-referrer"
                                      src={m.image}
                                      className="rounded-xl border border-white/10 max-w-full shadow-md h-28 object-cover cursor-pointer hover:opacity-80"
                                      onClick={() => setReplyingTo(m)}
                                      alt="adjunto"
                                    />
                                  </div>
                            ...
                            <div className="flex gap-2 w-full mt-1.5 group">
                              ...
                              >
                                <img
                                  referrerPolicy="no-referrer"
                                  src={avatarUrl}
                                  className="w-8 h-8 rounded-full object-cover border border-[#5A52A5]/30 shadow-sm bg-white/5"
                                  alt={m.sender}
                                />
                                {decUrl && (
                                  <div className="absolute -inset-3 pointer-events-none z-10 flex items-center justify-center">
                                    <img
                                      referrerPolicy="no-referrer"
                                      src={decUrl}
                                      className="w-[130%] h-[130%] object-contain filter drop-shadow-sm opacity-80 mix-blend-multiply"
                                      style={{ imageRendering: "pixelated" }}
                                      alt=""
                                    />
                                  </div>
                              ...
                              <div className="bg-[#F2E3C6] rounded-[20px] rounded-tl-sm px-3.5 py-2 max-w-[85%] shadow-sm flex flex-col relative min-w-[150px]">
                                ...
                                {m.replyTo && (
                                  <div className="bg-black/5 border-l-2 border-[#5A52A5]/50 px-2 py-1 mb-1 rounded text-xs text-gray-700 italic flex flex-col">
                                    <span className="font-bold text-[#5A52A5]">
                                      {m.replyTo.sender}
                                    </span>
                                    <span className="truncate">
                                      {m.replyTo.text}
                                ...
                                <div className="flex flex-wrap items-end justify-between gap-2">
                                  <span
                                    className="text-[#1A2035] text-[14px] leading-snug flex-1 cursor-pointer hover:bg-black/5 rounded px-1 transition-colors"
                                    onClick={() => setReplyingTo(m)}
                                  >
                                    {m.text}
                                  </span>
                                  <button
                                    onClick={() => setReplyingTo(m)}
                                    className="opacity-0 group-hover:opacity-100 transition-opacity text-[#5A52A5] hover:text-[#1A2035] p-1"
                                    title="Responder"
                                  >
                                    <svg
                                      xmlns="http://www.w3.org/2000/svg"
                                  ...
                                  <span className="text-[#8B98B0] text-[11px] font-mono shrink-0 ml-auto pl-2 pt-1">
                                    {timeStr}
                                  </span>
                                </div>
                                ...
                                {m.type === "chess_invite" && m.inviteData && (
                                  <button
                                    ...
                                    onClick={() => {
                                      ...
                                      if (
                                        (user.lizCoins || 0) < m.inviteData!.bet
                                      ) {
                                        alert(
                                          "No tienes suficientes Liz-Moneditas.",
                                        );
                                        return;
                                      }
                                      socket.emit(
      ...
      {selectedUserModal && (
        ...
        >
          <div
            className="bg-[#12141c] p-8 rounded-3xl w-full max-w-sm shadow-2xl relative border border-white/10 text-center"
          ...
          >
            ...
            <div
              ...
              onClick={() => {
                if (
                  selectedUserModal.isAi &&
                  user.username.trim() === "Axiss"
                ) {
                  setAiProfileForm({
                    profilePic: selectedUserModal.profilePic || "",
                    statusMessage:
                      selectedUserModal.statusMessage ||
                      "Inteligencia Artificial",
                    systemInstruction:
                      selectedUserModal.systemInstruction || "",
                  });
              ...
              {selectedUserModal.activeDecoration && (
                <div className="absolute -inset-4 pointer-events-none z-10 flex items-center justify-center">
                  <img
                    ...
                    src={
                      DECORATIONS.find(
                        (d) => d.id === selectedUserModal.activeDecoration,
                      )?.url
                    }
            ...
            <h3 className="text-xl font-bold text-white mb-1 flex items-center justify-center gap-2">
              ...
              {Array.isArray(selectedUserModal.awards) &&
                selectedUserModal.awards.map((award, idx) => (
                  <span
                    key={idx}
                    className="text-xl"
                    title="Galardón: Pluma Infinita"
                  >
                    {award}
                  </span>
                ))}
              {selectedUserModal.role === "admin" && (
                <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-fuchsia-500/20 text-fuchsia-400 border border-fuchsia-500/30">
                  Admin
                </span>
              )}
            </h3>
            ...
            <div className="bg-[#0a0a16] border border-white/5 p-4 rounded-2xl relative mb-4">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#12141c] px-2 text-xs text-gray-500 font-semibold uppercase">
                Estado
              </div>
            ...
            <div className="bg-[#0a0a16] border border-cyan-500/20 p-4 rounded-2xl relative mb-4">
              ...
              selectedUserModal.is_friends_public ? (
                <p className="text-gray-300 text-sm">
                  {(selectedUserModal.username === user.username
                    ? user.friends_list
                    : selectedUserModal.friends_list
                  )?.length
                    ? (selectedUserModal.username === user.username
                        ? user.friends_list
                        : selectedUserModal.friends_list
                  ...
                  <button
                    onClick={() => {
                      window.history.pushState(
                        ...
                        "",
                        "/chat/" +
                          encodeURIComponent(selectedUserModal.username),
                      );
